...
<div id="tp" style="width:100%; height:300px;"></div>
                        ...
                        <ul class="dash">                         
                        	<li>
								<a class="tip" href="<?php echo base_url(); ?>index.php?module=reports&amp;view=close_totals" title="Ventas del día">
									<i><img src="<?php echo $this->config->base_url(); ?>assets/img/icons/report.png" alt="" /></i>
									<span><span>Ventas del día</span></span>
								</a>
							</li>
							<li>
								<a class="tip" href="<?php echo base_url(); ?>index.php?module=reports&amp;view=close_totals_weekly" title="Ventas de la semana">
									<i><img src="<?php echo $this->config->base_url(); ?>assets/img/icons/report.png" alt="" /></i>
									<span><span>Ventas de la semana</span></span>
								</a>
							</li>
							<li>
