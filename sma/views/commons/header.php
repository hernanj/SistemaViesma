                ...
                <div class="navbar-inner">
                    ...
                    <div class="nav-collapse collapse">
                        <ul class="nav pull-right">
                            <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Hola, <?php echo FIRST_NAME; ?>! <b class="caret"></b></a>
                        ...
                        <ul class="nav pull-right">
                            ...
                            if (file_exists('sma/modules/pos/controllers/pos.php') && is_dir('sma/modules/pos')) {
                                echo '<li><a href="index.php?module=pos" class="btn btn-success hbtn">Punto de venta</a></li>';
                            }
                            if (ALERT_NO > 0) {
                        ...
                        <?php } ?>
                            <li class="dropdown"><a class="showSubMenus" href="#reportsMenu"><i class="icon-tasks  icon-white"></i> <?php echo $this->lang->line('reports'); ?> <b class="caret"></b></a>
                                <ul class="nav nav-tabs nav-stacked sub-menu" id="reportsMenu">
                                    ...
                                    <li><a href="<?php echo base_url(); ?>index.php?module=reports&view=close_totals"> Ventas Totales diarias</a></li>
                                    <li><a href="<?php echo base_url(); ?>index.php?module=reports&view=close_totals_weekly"> Ventas Totales semanales</a></li>
                                </ul>
                            </li>
                        </ul>
                                <?php } ?>
